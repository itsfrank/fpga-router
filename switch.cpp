...
static void DrawConnections(SegChannel* ch1, SegChannel* ch2, float x_offset, float y_offset, int ch1_dir, int ch2_dir) {
...
void Switch::draw()
{
	...
	if (this->channels[UP] && this->channels[RIGHT]) DrawConnections(this->channels[UP], this->channels[RIGHT], x_offset, y_offset, UP, RIGHT);
	if (this->channels[UP] && this->channels[DOWN]) DrawConnections(this->channels[UP], this->channels[DOWN], x_offset, y_offset, UP, DOWN);
	if (this->channels[UP] && this->channels[LEFT]) DrawConnections(this->channels[UP], this->channels[LEFT], x_offset, y_offset, UP, LEFT);
	if (this->channels[RIGHT] && this->channels[DOWN]) DrawConnections(this->channels[RIGHT], this->channels[DOWN], x_offset, y_offset, RIGHT, DOWN);
	if (this->channels[RIGHT] && this->channels[LEFT]) DrawConnections(this->channels[RIGHT], this->channels[LEFT], x_offset, y_offset, RIGHT, LEFT);
	if (this->channels[DOWN] && this->channels[LEFT]) DrawConnections(this->channels[DOWN], this->channels[LEFT], x_offset, y_offset, DOWN, LEFT);
